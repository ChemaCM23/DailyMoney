<x-app-layout>
    ...
    <div class="max-w-md mx-auto p-6 fondoUser overflow-hidden shadow-sm sm:rounded-lg mt-10 mb-10">
        <form method="post" action="{{ route('admin.update', ['admin' => $user->id]) }}" class="space-y-6">
            @csrf
            @method('PUT')
            <div class=" text-center">
                <h2 class="text-3xl font-bold text-white">Editor de Perfil</h2>
            </div>
            <div class="border rounded-md p-4">
                ...
                <div class="mt-6">
                    <label for="surname" class="block text-sm font-medium  text-white">Apellido</label>
